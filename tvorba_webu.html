    ...
    <main>
        ...
        <section id="strategy-section-1" class="web-section">
            <div class="web-row web-row-1">
                <div class="web-1-row-left">
                    ...
                    <div class="web-row-buttons">
                        <button class="btn btn-outline-danger">Více informací<i class="bi bi-arrow-right-short"></i></button>
                    </div>
                </div>
                <div class="web-row-right">
                    <img class="web-img" src="Images/Website/firm_graphics_main_picture.png" alt="">
                </div>
            </div>
                ...
                <div style="text-align: center; width: 100%;">
                    ...
                    <div ><br><br>
                        <div class="web-grid-container" style="margin: 1rem; gap: 2rem;">
                            <div class="hoverRed web-tile" style="background-image: url(Images/svgs/web-tile-1.svg);">
                                <p class="web-tile-text">Audit aktuální situace, podle které zjistíme Váš stav
                                    a vytvoříme plán Vám přímo na míru</p>
                            </div>
                            <div class="hoverRed web-tile" style="background-image: url(Images/svgs/web-tile-2.svg);">
                                <p class="web-tile-text">Audit aktuální situace, podle které zjistíme Váš stav
                                    a vytvoříme plán Vám přímo na míru</p>
                            </div>
                            <div class="hoverRed web-tile" style="background-image: url(Images/svgs/web-tile-3.svg);">
                                <p class="web-tile-text">Audit aktuální situace, podle které zjistíme Váš stav
                                    a vytvoříme plán Vám přímo na míru</p>
                            </div>
                            <div class="hoverRed web-tile" style="background-image: url(Images/svgs/web-tile-4.svg);">
                                <p class="web-tile-text">Audit aktuální situace, podle které zjistíme Váš stav
                                    a vytvoříme plán Vám přímo na míru</p>
                            </div>
                        </div>
        ...
        <section id="strategy-section-2" class="web-section-2">
            <div class="web-row web-row-2">
                ...
                <div class="web-row-right">
                    <img class="web-img" src="Images/Website/subpage_websites_01.png" alt="">
                </div>
            </div>
            <div class="web-row web-row-2">
                <div class="web-row-left-1">
            ...
            <div class="web-row web-row-3">
                ...
                <div class="web-row-right">
                    <img class="web-img" src="Images/Website/subpage_websites_03.png" alt="">
                </div>
            </div>
            <div class="web-row web-row-4">
                <div class="web-row-left-2">
